...
The take home value at withdrawal for various scenarios in these retirement accounts are summarized below. Compared to Regular denotes the relationship of the take home value with that of a regular investment account. Adjusted growth rate $\cap{g}$ denotes the effective growth rate for the corresponding type of the retirement account after taking into the account the taxes/penalty due to an early withdrawal. 
